...
#undef max
        ...
        int num_groups() const { return num_groups_; } //add by cqq
        ...
        /** \brief Returns group id, add by cqq */
        //int my_group() const { return van_->my_group(); }
    ...
    private:
        ...
        int num_servers_, num_workers_, num_groups_=1;//add by cqq
